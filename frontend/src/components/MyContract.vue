        ...
        <section class="content" >
            ...
            <v-container>
                    ...
                    <v-dialog 
                        ...
                        <v-card>
                            ...
                            <v-card-actions>
                                ...
                                <v-btn 
                                    @click="dialogDelete=!dialogDelete,deleteContractt()"
                                >
                                    Удалить
                                </v-btn>
                            </v-card-actions>
                ...
                <section 
                    ...
                    <v-row>
                        <v-col 
                            v-for="(field, index) in fields" :key="index" cols="2,5">                                            
                    ...
                    >
                        ...
                        <tbody>
                            <tr v-for="(item) in contracts"
                                ...
                                <td>{{ item.amount }}</td>
                                <td>
                                    <div v-for="(items,id) in item.phases" :key='id'>
                                        {{ items.name }}
                                    </div>
                                </td>
                                <td>
                                    <div v-for="(items,id) in item.contractCounterparties" :key='id'>
                                        {{ items.name }}
                                    </div>
                                </td>
                            </tr>
